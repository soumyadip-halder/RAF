  ...
  return (
    ...
    >
      <Switch>
        ...
        <AuthRoute
          path={`${path}/mypendingactions`}
          component={RcmMyPendingTaks}
          isAuthorized={true}
          serviceError={serviceError}
          arb={false}
        />
        ...
        <AuthRoute
          path={`${path}/scopemeeting`}
          component={PendingActionsScopeMeeting}
          isAuthorized={true}
          serviceError={serviceError}
          arb={false}
        />
